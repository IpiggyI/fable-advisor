...
|---|---|---|---|
| Routine | **Grok** (catalog-selected, currently grok-4.6) | `scripts/run-grok.mjs` runner (default) | The spec fully determines the outcome — Grok does the typing via the [Grok CLI](https://x.ai/cli) |
