...
A **lane** answers how a vendor is reached; roles and tiers answer what is dispatched. Which (role, tier) maps to which lane and dial is a user-side **fill table** in your rules; the plugin ships no default table.
